import{j as a,b as n,c as s,L as p,aa as t,G as r}from"./chunks/framework.D8w0pJIA.js";const f=JSON.parse('{"title":"Vue-CLI2 中的 render: h => h(App) 解析","description":"","frontmatter":{"title":"Vue-CLI2 中的 render: h => h(App) 解析","date":"2018-07-08T20:08:08.000Z","tag":["Vue"],"categories":["前端进击"]},"headers":[],"relativePath":"posts/growth-record/frame/vue/render-app.md","filePath":"posts/growth-record/frame/vue/render-app.md","lastUpdated":1713675008000}'),l={name:"posts/growth-record/frame/vue/render-app.md"},c=t(`<h1 id="vue-cli2-中的-render-h-h-app-解析" tabindex="-1">Vue-CLI2 中的 render: h =&gt; h(App) 解析 <a class="header-anchor" href="#vue-cli2-中的-render-h-h-app-解析" aria-label="Permalink to &quot;Vue-CLI2 中的 render: h =&gt; h(App) 解析&quot;">​</a></h1><p><strong>对于这个，可能es6语法不熟的人很容易产生懵懂，因为我也不熟，所以记录一下，毕竟这也是个重要的知识点。</strong></p><h3 id="一-遇到的问题代码" tabindex="-1">（一）遇到的问题代码： <a class="header-anchor" href="#一-遇到的问题代码" aria-label="Permalink to &quot;（一）遇到的问题代码：&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>new Vue({</span></span>
...
<span class="line"><span>&lt;/body&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;/html&gt;</span></span></code></pre></div><p>运行结果是：</p>`,22);function o(i,d,h,u,m,g){const e=r("CustomImage");return n(),s("div",null,[c,p(e,{src:"/growth-record/frame/vue/render-app.png"})])}const b=a(l,[["render",o]]);export{f as __pageData,b as default};
