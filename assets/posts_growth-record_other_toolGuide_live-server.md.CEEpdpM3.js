...
<span class="line"><span>--version | -v - display version and exit</span></span></code></pre></div><p>3.也可以把配置放在package.json的scripts下的server中，这样不用每次都命令行使用参数，然后使用命令行启动：<code>npm run server</code>（如何创建一个带package.json包的项目请看下一步）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;scripts&quot;: {</span></span>
<span class="line"><span>  &quot;server&quot;: &quot;live-server ./ --port=8081&quot;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>4.创建一个带package.json包的项目，在项目根目录下使用命令行：<code>npm init</code>，可以自己设置</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package name: (0710) demo</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Is this OK? (yes)</span></span></code></pre></div><p>然后使用第三步的配置，运行该项目就使用：<code>npm run server</code></p>`,7),f=s("p",null,[s("strong",null,[e("注意：如果浏览器不能实时自动刷新页面，可以试试用这个命令启动（亲测有效）："),s("code",null,"live-server")])],-1);function b(q,T,w,P,y,x){const n=o("CustomImage");return i(),r("div",{"data-pagefind-body":!0},[c,a(n,{src:"/growth-record/other/toolGuide/live-server-01.png"}),d,u,a(n,{src:"/growth-record/other/toolGuide/live-server-02.png"}),h,a(n,{src:"/growth-record/other/toolGuide/live-server-03.png"}),v,g,m,a(n,{src:"/growth-record/other/toolGuide/live-server-04.png"}),_,a(n,{src:"/growth-record/other/toolGuide/live-server-04.png"}),f])}const A=t(l,[["render",b]]);export{k as __pageData,A as default};
