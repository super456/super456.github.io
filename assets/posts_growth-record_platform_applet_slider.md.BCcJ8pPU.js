import{_ as e,D as l,c as t,o as i,j as s,I as n,a6 as c,a as p}from"./chunks/framework.BOyJDVBP.js";const C=JSON.parse('{"title":"微信小程序之简单双向调节的 Slider 滑动选择器","description":"","frontmatter":{"title":"微信小程序之简单双向调节的 Slider 滑动选择器","date":"2018-08-22T20:08:08.000Z","tag":["微信小程序"],"categories":["前端进击"]},"headers":[],"relativePath":"posts/growth-record/platform/applet/slider.md","filePath":"posts/growth-record/platform/applet/slider.md","lastUpdated":1713671501000}'),r={name:"posts/growth-record/platform/applet/slider.md"},o=s("h1",{id:"微信小程序之简单双向调节的-slider-滑动选择器",tabindex:"-1"},[p("微信小程序之简单双向调节的 Slider 滑动选择器 "),s("a",{class:"header-anchor",href:"#微信小程序之简单双向调节的-slider-滑动选择器","aria-label":'Permalink to "微信小程序之简单双向调节的 Slider 滑动选择器"'},"​")],-1),d=s("p",null,"简单说明一下，这是用微信官方的slider组件拼接的，没有用到其他框架哈。",-1),h=s("h3",{id:"一-实现效果",tabindex:"-1"},[p("（一）实现效果 "),s("a",{class:"header-anchor",href:"#一-实现效果","aria-label":'Permalink to "（一）实现效果"'},"​")],-1),g=c(`<h3 id="二-实现过程" tabindex="-1">（二）实现过程 <a class="header-anchor" href="#二-实现过程" aria-label="Permalink to &quot;（二）实现过程&quot;">​</a></h3><p>主要是将两个滑动选择器拼接在一起、各自设置所占长度比，就可以实现双向滚动调节了，但是有一个问题，我没有解决到，就是一个固定的滑动区域内，左右滑块可以相互交接互相滑动，尝试了一下没弄出来。 1、wxml代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;view class=&#39;sliderHCon&#39;&gt;</span></span>
...
<span class="line"><span>  &lt;/view&gt;</span></span>
<span class="line"><span>&lt;/view&gt;</span></span></code></pre></div><p>2、wxss代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>.sliderHCon {</span></span>
...
<span class="line"><span>  justify-content: center;</span></span>
<span class="line"><span>  align-items: center;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>3、js代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  /**</span></span>
