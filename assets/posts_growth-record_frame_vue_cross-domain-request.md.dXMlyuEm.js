import{j as p,b as e,c as l,L as a,aa as n,G as t}from"./chunks/framework.BdPFiiJb.js";const b=JSON.parse('{"title":"Vue-CLI2 跨域请求 Demo（fetch、axios、proxyTable）","description":"","frontmatter":{"title":"Vue-CLI2 跨域请求 Demo（fetch、axios、proxyTable）","date":"2018-07-09T20:02:01.000Z","tag":["Vue"],"categories":["前端进击"]},"headers":[],"relativePath":"posts/growth-record/frame/vue/cross-domain-request.md","filePath":"posts/growth-record/frame/vue/cross-domain-request.md","lastUpdated":1713671501000}'),o={name:"posts/growth-record/frame/vue/cross-domain-request.md"},i=n('<h1 id="vue-cli2-跨域请求-demo-fetch、axios、proxytable" tabindex="-1">Vue-CLI2 跨域请求 Demo（fetch、axios、proxyTable） <a class="header-anchor" href="#vue-cli2-跨域请求-demo-fetch、axios、proxytable" aria-label="Permalink to &quot;Vue-CLI2 跨域请求 Demo（fetch、axios、proxyTable）&quot;">​</a></h1><p><strong>学习中需要应用到跨域请求的问题，找了资料，也自己写了一个简单的demo，应用到fetch方法或axios方法，前提都需要配置proxyTable，特别感谢：Web前端网站教程-米斯特吴老师提供的案例和请求接口。</strong></p><h3 id="一-安装vue-cli2-x脚手架" tabindex="-1">（一）安装vue-cli2.x脚手架 <a class="header-anchor" href="#一-安装vue-cli2-x脚手架" aria-label="Permalink to &quot;（一）安装vue-cli2.x脚手架&quot;">​</a></h3><p>如果还没安装的，或安装过程不熟的，可以参考这篇文章教程，写的很详细——<a href="https://www.jianshu.com/p/1626b8643676/" target="_blank" rel="noreferrer">Vue2.0史上最全入坑教程（上）—— 搭建Vue脚手架（vue-cli）</a></p><h3 id="二-配置proxytable跨域请求" tabindex="-1">（二）配置proxyTable跨域请求 <a class="header-anchor" href="#二-配置proxytable跨域请求" aria-label="Permalink to &quot;（二）配置proxyTable跨域请求&quot;">​</a></h3><p>1.找到config文件夹下的index.js文件打开，找到proxyTable配置项：</p>',6),c=n(`<p>2.配置代码参考如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    //配置跨域请求,注意配置完之后需要重启编译该项目</span></span>
...
<span class="line"><span>      }</span></span>
<span class="line"><span>    },</span></span></code></pre></div><p>**注意：**可能你的接口地址原本是 <code>http://www.thenewstep.cn/test/test.html</code>，但是为了匹配代理地址，需要在前面加一个 <code>/apis</code>（自己定义的请求接口变量名）, 因此接口地址需要写成这样的即可生效 <code>/apis/test/test.html</code>。</p><h3 id="三-使用fetch实现跨域请求" tabindex="-1">（三）使用fetch实现跨域请求 <a class="header-anchor" href="#三-使用fetch实现跨域请求" aria-label="Permalink to &quot;（三）使用fetch实现跨域请求&quot;">​</a></h3><p>1.在App.vue中添加以下代码即可：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>})</span></span></code></pre></div><p>3.修改App.vue组件代码为：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>&lt;div id=&quot;app&quot;&gt;</span></span>
<span class="line"><span>    &lt;img src=&quot;./assets/logo.png&quot;&gt;</span></span>
<span class="line"><span>    &lt;HelloWorld/&gt;</span></span>
<span class="line"><span>&lt;/div&gt;</span></span>
...
<span class="line"><span>    margin-top: 60px;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/style&gt;</span></span></code></pre></div><p>4.运行结果：</p>`,6);function d(u,h,g,m,f,x){const s=t("CustomImage");return e(),l("div",null,[i,a(s,{src:"/growth-record/frame/vue/cross-01.png"}),c,a(s,{src:"/growth-record/frame/vue/cross-02.png"}),r,a(s,{src:"/growth-record/frame/vue/cross-03.png"})])}const q=p(o,[["render",d]]);export{b as __pageData,q as default};
