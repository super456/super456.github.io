...
<span class="line"><span>    })</span></span>
<span class="line"><span>  },</span></span>
<span class="line"><span>})</span></span></code></pre></div><p>2、设置wxml:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;view class=&quot;table&quot;&gt;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    &lt;/view&gt;</span></span>
<span class="line"><span>  &lt;/block&gt;</span></span>
<span class="line"><span>&lt;/view&gt;</span></span></code></pre></div><p>3、设置wxss:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>.table {</span></span>
...
<span class="line"><span>  text-align: center;</span></span>
<span class="line"><span>  vertical-align: middle;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>总的来说，实现过程并不复杂，学会了可以使用很熟练的使用，这个方法实现表格布局还是挺有用的，在一些页面无缝接触的时候很常用。</p>`,10);function h(g,m,u,_,w,f){const a=e("CustomImage");return c(),t("div",{"data-pagefind-body":!0},[r,s(a,{src:"/growth-record/platform/applet/custom-table-layout-01.png"}),d,s(a,{src:"/growth-record/platform/applet/custom-table-layout-02.png"}),b])}const x=l(o,[["render",h]]);export{v as __pageData,x as default};
