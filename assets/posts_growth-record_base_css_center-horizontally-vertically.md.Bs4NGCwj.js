...
<span class="line"><span> }</span></span></code></pre></div><p>运行结果：</p></li></ol>`,4),r=n(`<ol start="2"><li>设置 使用position的绝对定位和margin的居中定位，top和left设置与屏幕相距成50%，然后用transform向左（上）平移它自己宽度（高度）的50%即可：<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    .box1 {</span></span>
<span class="line"><span>     width: 400px;</span></span>
<span class="line"><span>     height: 400px;</span></span>
<span class="line"><span>     margin: auto;</span></span>
<span class="line"><span>     border: 1px solid red;</span></span>
...
<span class="line"><span> }</span></span></code></pre></div></li></ol><p>运行结果一样。 3. 设置 使用position的绝对定位和margin的居中定位，top和left设置与屏幕相距成50%，使用<code>margin:高的一半px 0 0 宽的一半px;</code> 即可：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>    .box1 {</span></span>
<span class="line"><span>     width: 400px;</span></span>
<span class="line"><span>     height: 400px;</span></span>
<span class="line"><span>     margin: auto;</span></span>
<span class="line"><span>     border: 1px solid red;</span></span>
...
<span class="line"><span> }</span></span></code></pre></div>运行结果：</li></ol>`,6),d=p("ol",{start:"2"},[p("li",null,"通过css设置父元素为display: table，子元素为 display: table-cell，这种方法是让元素包含的内容居中，但是会占据整个父元素，因为子元素没有设置宽高的，如下所示（红线方框是设置宽高的父元素）：")],-1),h=n(`<ol start="3"><li>最实用的方法：css3新的布局方法——弹性布局 display: flex。在这个方法中，不管是在已知或未知元素宽高的情况下，都能使元素居中显示（推荐使用）。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>//css</span></span>
<span class="line"><span>.box1 {</span></span>
<span class="line"><span>        width: 400px;</span></span>
<span class="line"><span>        height: 400px;</span></span>
<span class="line"><span>        margin: auto;</span></span>
...
<span class="line"><span>    .box2 {</span></span>
<span class="line"><span>        border: 5px solid green;</span></span>
<span class="line"><span>    }</span></span></code></pre></div><p>运行结果：</p>`,3);function g(b,u,_,m,v,x){const s=i("CustomImage");return l(),t("div",null,[c,a(s,{src:"/growth-record/base/css/center-01.png"}),r,a(s,{src:"/growth-record/base/css/center-02.png"}),d,a(s,{src:"/growth-record/base/css/center-03.png"}),h,a(s,{src:"/growth-record/base/css/center-04.png"})])}const y=e(o,[["render",g]]);export{C as __pageData,y as default};
