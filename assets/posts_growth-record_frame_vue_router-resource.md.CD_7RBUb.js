import{j as p,b as e,c as l,L as n,aa as a,G as t}from"./chunks/framework.BdPFiiJb.js";const b=JSON.parse('{"title":"Vue-CLI2 中的 Vue-Router 和 Vue-resource 实战","description":"","frontmatter":{"title":"Vue-CLI2 中的 Vue-Router 和 Vue-resource 实战","date":"2018-07-09T20:04:01.000Z","tag":["Vue"],"categories":["前端进击"]},"headers":[],"relativePath":"posts/growth-record/frame/vue/router-resource.md","filePath":"posts/growth-record/frame/vue/router-resource.md","lastUpdated":1713675008000}'),o={name:"posts/growth-record/frame/vue/router-resource.md"},r=a('<h1 id="vue-cli2-中的-vue-router-和-vue-resource-实战" tabindex="-1">Vue-CLI2 中的 Vue-Router 和 Vue-Resource 实战 <a class="header-anchor" href="#vue-cli2-中的-vue-router-和-vue-resource-实战" aria-label="Permalink to &quot;Vue-CLI2 中的 Vue-Router 和 Vue-Resource 实战&quot;">​</a></h1><p><strong>简单记录一下这两个插件的使用方法，写了一个demo，方便理解及应用。</strong></p><h3 id="一-安装vue-cli2-x脚手架" tabindex="-1">（一）安装vue-cli2.x脚手架 <a class="header-anchor" href="#一-安装vue-cli2-x脚手架" aria-label="Permalink to &quot;（一）安装vue-cli2.x脚手架&quot;">​</a></h3><p>如果还没安装的，或安装过程不熟的，可以参考这篇文章教程，写的很详细——<a href="https://www.jianshu.com/p/1626b8643676/" target="_blank" rel="noreferrer">Vue2.0史上最全入坑教程（上）—— 搭建Vue脚手架（vue-cli）</a>，这个文章作者真的很用心，向他学习。</p><h3 id="二-安装vue-router和vue-resource插件" tabindex="-1">（二）安装vue-router和vue-resource插件 <a class="header-anchor" href="#二-安装vue-router和vue-resource插件" aria-label="Permalink to &quot;（二）安装vue-router和vue-resource插件&quot;">​</a></h3><p>如果在安装脚手架的时候安装了vue-router，可以直接跳转到安装vue-resource。 如果不是的，可以使用命令：<code>cd &lt;项目文件夹&gt;</code> 切换到项目文件夹路径下，然后使用命令行安装：<code>npm install vue-router --save</code> 和<code>npm install vue-resource --save</code></p><p>这里说明一下安装<code>npm install 插件 +[参数]</code>，表示的意思： 1.使用：<code>npm install 插件</code> ：会把这个插件安装到node_modules目录中，但不会修改package.json内容；</p><p>2.<code>npm install 插件 --save</code> ：在项目发布上线之后还会依赖用到的插件，没有这个插件，项目不能正常的运行，自动更改package.json内容 ；</p><p>3.<code>npm install 插件 --save-dev </code>：把插件安装到开发依赖中，项目上线之后不会用到的插件，针对个别插件，比如说这个“babel-loader”，是在项目编译解析完成后发布就没用到了的，自动更改package.json内容；</p><h3 id="三-使用vue-router-vue-resource写一个跳转请求页面数据的demo" tabindex="-1">（三）使用vue-router+vue-resource写一个跳转请求页面数据的demo <a class="header-anchor" href="#三-使用vue-router-vue-resource写一个跳转请求页面数据的demo" aria-label="Permalink to &quot;（三）使用vue-router+vue-resource写一个跳转请求页面数据的demo&quot;">​</a></h3><p>1.先看一下安装脚手架的时候安装的路由界面及配置：</p>',11),i=a(`<p>2.如果一开始没有的安装vue-router后自己手动安装的，可以参考这个main.js 和router文件夹的index.js配置的配置代码如下： main.js代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import Vue from &#39;vue&#39;</span></span>
...
<span class="line"><span>})</span></span></code></pre></div><p>3.添加一个组件Home.vue，添加位置如下：</p>`,6),c=a(`<p>组件代码为：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>&lt;/style&gt;</span></span></code></pre></div><p>4.需要在根组件App.vue下添加一下引入组件的内容：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/style&gt;</span></span></code></pre></div><h3 id="四-运行结果" tabindex="-1">（四）运行结果 <a class="header-anchor" href="#四-运行结果" aria-label="Permalink to &quot;（四）运行结果&quot;">​</a></h3>`,5);function u(d,g,m,h,v,_){const s=t("CustomImage");return e(),l("div",null,[r,n(s,{src:"/growth-record/frame/vue/router-01.png"}),i,n(s,{src:"/growth-record/frame/vue/router-02.png"}),c,n(s,{src:"/growth-record/frame/vue/router-03.gif"})])}const q=p(o,[["render",u]]);export{b as __pageData,q as default};
