...
---
# 微信小程序之物流状态时间轴
刚好写了一个物流状态的时间轴，简单分享一下哈。

### （一）实现效果
真机测试的结果（图片忘记缩小了）
<CustomImage src='/growth-record/platform/applet/status-timeline-01.webp' />
[github下载源码](https://github.com/super456/weapp_expressTime)

### （二）实现分析
页面布局拆分：
<CustomImage src='/growth-record/platform/applet/status-timeline-02.webp' />
...
**如果感觉有用的话，点个赞呗，支持一下我哈。[github下载源码](https://github.com/super456/weapp_expressTime)**
